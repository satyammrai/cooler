      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          >
            ...
            <span className="text-3xl font-black text-positivus-dark tracking-tighter uppercase">Kapsun</span>
          </button>
            ...
            {navLinks.map((link) => (
              <button
                ...
                className={`transition-colors font-medium ${
                  currentView === link.id ? 'text-positivus-green underline underline-offset-4 decoration-2' : 'text-positivus-dark hover:text-positivus-green'
                }`}
              >
                {link.name}
              </button>
