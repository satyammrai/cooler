...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-positivus-green bg-gray-950/10 px-4 py-2 shadow-[0px_4px_24px_#B9FF66] transition-colors hover:bg-slate-950/50 text-white font-bold",
        className
      )}
      {...props}
    />
