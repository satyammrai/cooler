    ...
    <section className="py-20 px-4 max-w-7xl mx-auto" id="products">
      ...
      {antarcticaProducts.length > 0 && (
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-6 mb-10">
            <h2 className="text-4xl font-bold">Antarctica</h2>
            <p className="text-lg mt-2 opacity-90">Industrial-grade cooling solutions for extreme environments</p>
          </div>
      ...
      {himalayaProducts.length > 0 && (
        <motion.div
          ...
          className="mb-20"
        >
          <div className="bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl p-6 mb-10">
            <h2 className="text-4xl font-bold">Himalaya</h2>
            <p className="text-lg mt-2 opacity-90">Eco-friendly residential and commercial cooling solutions</p>
          </div>
